/* A text input with a fixed prefix drawn inside its border ("$ 2,400"), for typed amounts.
   Feature-local, with a twin in features/challenge/form/price, until the shared Input grows a prefix slot (roadmap 11, step 2
...
export const PrefixedInput = forwardRef<HTMLInputElement, PrefixedInputProps>(function PrefixedInput({ prefix, className, ...rest }, ref) {
  return (
    ...
    <span className="publish-prefixed-input" style={{ '--prefix-chars': prefix.length } as CSSProperties}>

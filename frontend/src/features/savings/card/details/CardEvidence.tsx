...
export function CardEvidence({ card }: { card: SavingsCardView }): JSX.Element {
  ...
  return (
    <Stack gap={4}>
      <section>
        <h5 className="savings-details__heading">Market rate ({rates.source}, {rates.status})</h5>
      ...
      <section>
        <h5 className="savings-details__heading">Awards ({suppliers.source}, {suppliers.status})</h5>
        <p className="ui-text-sm">
      ...
      <section>
        <h5 className="savings-details__heading">Not checked</h5>

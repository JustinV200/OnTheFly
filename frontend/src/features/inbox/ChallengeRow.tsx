    ...
    <tr style={{ borderTop: '1px solid #e2e8f0', verticalAlign: 'top' }}>
      ...
      <td>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.25rem' }}>
          ...
          {hasDeltas ? null : <span>Covers the requested scope</span>}
        </div>
      </td>
      <td>
        <MoneyDisplay amountMinor={challenge.normalized_price_minor} currency={challenge.price_currency} /> / month
        <div style={{ color: '#475569', fontSize: '0.85rem' }}>{Math.round(challenge.scope_completeness * 100)}% of scope</div>
      </td>
      <td><SavingsCell challengeId={challenge.challenge_id} currency={challenge.price_currency} savings={challenge.savings} /></td>
